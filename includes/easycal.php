...
class Easycal {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Easycal_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Easycal_Loader. Orchestrates the hooks of the plugin.
	 * - Easycal_i18n. Defines internationalization functionality.
	 * - Easycal_Admin. Defines all hooks for the admin area.
	 * - Easycal_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Easycal_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Easycal_Loader    Orchestrates the hooks of the plugin.
	 */
